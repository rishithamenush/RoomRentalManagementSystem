...
<script>
	...
	$('#new_tenant').click(function(){
		uni_modal("New Tenant","pages/manage_tenant.php","mid-large")
		
	})

	$('.view_payment').click(function(){
		uni_modal("Tenants Payments","pages/view_payment.php?id="+$(this).attr('data-id'),"large")
		
	})
	$('.edit_tenant').click(function(){
		uni_modal("Manage Tenant Details","pages/manage_tenant.php?id="+$(this).attr('data-id'),"mid-large")
	...
	function delete_tenant($id){
		start_load()
		$.ajax({
			url:'api/ajax.php?action=delete_tenant',
			method:'POST',
			data:{id:$id},
