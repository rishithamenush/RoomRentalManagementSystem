...
<style>
    ...
    #bookingErrorModal .modal-header {
        border-radius: 15px 15px 0 0;
        border-bottom: none;
    }
    
    #bookingErrorModal .modal-body {
        padding: 2rem;
    }
    
    #bookingErrorModal .modal-footer {
        border-top: none;
        border-radius: 0 0 15px 15px;
        padding: 1rem 2rem;
    }
    
    #bookingErrorModal .alert-info {
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title" id="bookingErrorModalLabel">
                            <i class="fa fa-exclamation-triangle"></i> Booking Error
                        </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-center" id="bookingErrorMessage">An error occurred while processing your booking request.</p>
                        <div class="alert alert-info">
                            <strong>Common Solutions:</strong>
                            <ul class="mb-0 mt-2">
                                <li>Try different dates that don't overlap with existing bookings</li>
                                <li>Select a different property</li>
                                <li>Contact the property owner for availability</li>
                            </ul>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary" onclick="window.location.href='index.php?page=search'">
                            <i class="fa fa-search"></i> Find Other Properties
                        </button>
                    </div>
                </div>
            </div>
...
function submitBooking() {
    ...
    $.ajax({
        url: 'api/ajax.php?action=request_booking',
        method: 'POST',
        data: formData,
        processData: false,
        contentType: false,
        ...
        error: function() {
            showBookingError('Failed to send booking request. Please try again.');
        },
        complete: function() {
...
function showBookingError(message) {
    ...
    $('#bookingErrorMessage').text(message);
