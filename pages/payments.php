...
<script>
	...
	$('#new_payment').click(function(){
		uni_modal("New payment","pages/manage_payment.php","mid-large")
		
	})
	$('.edit_payment').click(function(){
		uni_modal("Manage payment Details","pages/manage_payment.php?id="+$(this).attr('data-id'),"mid-large")
		
	})
	$('.view_payment').click(function(){
		uni_modal("Tenants Payments","pages/view_payment.php?id="+$(this).attr('data-id'),"mid-large")
	...
	function delete_payment($id){
		start_load()
		$.ajax({
			url:'api/ajax.php?action=delete_payment',
			method:'POST',
			data:{id:$id},
